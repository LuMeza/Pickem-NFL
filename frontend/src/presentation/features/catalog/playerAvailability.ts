...
/** Designaciones semanales (`injuryStatus`) que se muestran como "En veremos". */
 ...
 * Cualquier valor de ESPN no reconocido cae en "Activo" por defecto — nunca
 * marcar a alguien como lesionado por un string inesperado.
 */
