...
/** /pickem/picks entra directo a la semana con los partidos más cercanos en el tiempo, igual que PickemStandingsRedirect. */
export function WeeklyPicksBoardRedirect() {
  ...
  return <Navigate to={`/pickem/picks/${defaultWeek.id}`} replace />
}
