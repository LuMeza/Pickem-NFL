...
export function AdminSurvivorPage() {
  ...
  return (
    <section>
      ...
      <p className="text-body-sm text-muted">
        Al perder con vidas disponibles, el jugador queda eliminado de inmediato pero tiene la semana siguiente para
        revivir eligiendo equipo a tiempo — sin que apruebes nada. Si no paga esa vida extra, retiralo del pool desde
        el panel de picks del jugador.
      </p>
