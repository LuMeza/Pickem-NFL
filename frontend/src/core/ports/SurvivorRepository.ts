 ...
 * Las vidas extra si tienen su propio flujo de solicitud/aprobacion — ver
...
export interface SurvivorRepository {
  ...
  /** Numero de la semana regular actualmente abierta, o null si ya se resolvieron todas (design.md decision 8). */
