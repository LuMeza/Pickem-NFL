...
/** Ver openspec/changes/base-plataforma design.md — precedencia de la carga manual sobre la sincronizacion automatica. */
 ...
 * (la sincronizacion automatica escribe por un camino aparte, ver
